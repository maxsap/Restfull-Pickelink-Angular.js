...
//import com.gr.project.security.service.UserRestService;
//import com.gr.ws.codecs.ChatProtocol;
//import com.gr.ws.codecs.JacksonEncoder;
//import com.gr.ws.codecs.ProtocolDecoder;
//import com.gr.ws.codecs.UserDecoder;
//import com.gr.ws.domain.UserMessage;
//
///**
...
//
////    @PathParam("room")
//    private String chatroomName = "test";
//
...
//    
//    @Inject UserRestService restService;
//    
//
//    /**
...
//    	
////    	restService.listAllPersons(); //will throw access denied exception
//    	
...
//                result.add(broadcaster.getID().split("/")[1]);
//            }
//        };
//        return result;
//    }
